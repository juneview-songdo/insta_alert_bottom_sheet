...
class _ViewState extends State<NewView> with AfterLayoutMixin<NewView> {
  ...
  void afterFirstLayout(BuildContext context) {
    viewAfterFirstLayout(context, widget.params, widget.tag, widget.slug);
  }
  ...
  Future<void> readyPage() async {
    if (isReadyView) return; // If it's already running, terminate it.
    await readyView(widget.params, context, widget.tag, widget.slug);
