...
T _button00 = T("00", onTap: (BuildContext context) async {
  ////////////////////////////////////////
  // 1. After registering the copy_router.md code on lib/util/config/router/component.dart

  // 2. The code below will navigate you to the desired location.
  NewNavigator(
    NewParams(),
    // tag: "someTag"
  ).movePagePush(context);
  ////////////////////////////////////////
});

T _button01 = T("01", onTap: (BuildContext context) async {
  ////////////////////////////////////////
  // move without go_router
  NewNavigator(
    NewParams(),
    // tag: "someTag"
